<template>
  <section class="strategyDetailItem">
    ...
    <div
      ...
      @click="toDetail"
    >
      <a href="https://www.mafengwo.cn/i/17505631.html" target="_blank">
        <div class="bar">
          <span class="stat"
...
export default {
  ...
  computed: {},
  created() {
    console.log("34", this.StrategyDetailItemData);
  },
  mounted() {},
  methods: {
    toDetail() {
      this.$router.push({
        name: "detail",
        params: {
          strategy_id: this.StrategyDetailItemData.strategy_id,
        },
      });
    },
  },
